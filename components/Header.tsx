  ...
  return (
    <div className="w-full h-24 px-12 pt-4">
        <div className="flex justify-around">
           ...
           <div className="px-4 hover:bg-gray-300 text-gray-700 font-medium border-[#006666] border-1 border-r-0 rounded-none">
                <Popover>
      ...
      {categories.map((c)=>(
        <CommandItem key={c}>{c}</CommandItem>
          ...
          <div className="flex justify-center items-center ">
              <div className="border-1 border-gray-300 w-28 h-10 mt-2 rounded-sm mx-3">
                <HeaderButtons/>
            </div>
          <div className="flex justify-center items-center border-1 border-gray-300 w-28 h-10 mt-2 rounded-sm mx-3 relative">
  <ShoppingCart />
...
<div className="flex justify-center items-center border-1 border-gray-300 w-28 h-10 mt-2 rounded-sm mx-3 relative">
  ...
  <span className="absolute -top-2 -right-1 bg-[#006666] text-white text-xs w-5 h-5 flex items-center justify-center rounded-full">
    2
            ...
            <div className="flex justify-center items-center border-1 border-gray-300 w-28 h-10 mt-2 rounded-sm  mx-3">
